                        ...
                        @foreach ($cartItems as $item)
                            ...
                            <tr class="border-b">
                                <td class="py-3 px-6 text-center">
                                    <input 
                                        type="checkbox" 
                                        class="pay-now-checkbox w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" 
                                        data-id="{{ $item->id }}" 
