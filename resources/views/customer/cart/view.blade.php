...
@section('content')
    <div class="container mx-auto p-6">
        ...
        @guest
            <div class="max-w-md mx-auto p-6 bg-blue-50 border-l-4 border-blue-400 text-blue-800 rounded-lg shadow-md">
                <h2 class="text-2xl font-semibold mb-3">You need to log in to access your cart</h2>
                <p class="mb-6 text-lg">Please log in or register to start shopping and manage your cart items.</p>
                <div class="flex justify-center space-x-6">
                    <a href="{{ route('login.show') }}" 
                    class="py-3 px-8 rounded-lg font-semibold shadow-md transition duration-300 ease-in-out border-2 border-cyan-500 text-cyan-600 hover:bg-cyan-500 hover:text-white">
                    Log In
                    </a>
                    <a href="{{ route('register.show') }}" 
                    class="py-3 px-8 rounded-lg font-semibold shadow-md transition duration-300 ease-in-out border-2 border-emerald-500 text-emerald-600 hover:bg-emerald-500 hover:text-white">
                    Register
                    </a>
                </div>
            </div>
