        ...
        <div class="w-64 h-screen fixed top-0 left-0 border-e border-gray-100 bg-white flex flex-col justify-between">
            <div class="px-4 py-6 overflow-y-auto">
                ...
                <ul class="mt-6 space-y-1">
                    ...
                    <li>
                        <a href="#"
                            class="block rounded-lg px-4 py-2 text-sm font-medium {{ request()->routeIs('admin.settings') ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700' }}">
                            Settings
                        </a>
                    </li>
                    <li>
